import os
from __init__ import import_xes
from __init__ import import_petri_net
from __init__ import generate_playout
...
print(
    " The output of the method is a List[List[str]], where the entry i,j is the j-th activity name of the i-th trace."
)
